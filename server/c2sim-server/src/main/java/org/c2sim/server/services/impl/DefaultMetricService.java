...
public class DefaultMetricService implements MetricService {
    ...
    public long incValidMessagesSendByC2SimClient(
        ...
        if (sharedSessionName != null &&
            ...
            logger.warn("Metric skipped incValidMessagesSendByC2SimClient due to missing or invalid parameters");
        }
        return 0;
    }
    ...
    public long incInvalidMessagesSendByC2SimClient(
        ...
        logger.error("Metric incInvalidMessagesSendByC2SimClient failed");
        return -1;
    }
    ...
    public void requestDuration(String method, String route, String status, Long durationNs) {
        if (method != null &&
                ...
                !route.isBlank() &&
                status != null &&
                !status.isBlank() && durationNs != null) {
            ...
            logger.error("Metric requestDuration failed");
        }
    }
    ...
    public long incBytesSendByC2SimClient(
        ...
        logger.warn("Metric incBytesSendByC2SimClient failed");
        return -1;
    }
}
