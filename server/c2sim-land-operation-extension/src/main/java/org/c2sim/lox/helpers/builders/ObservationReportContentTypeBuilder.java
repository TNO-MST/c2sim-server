...
public class ObservationReportContentTypeBuilder {
   ...
   * @return this builder
   */
  public ObservationReportContentTypeBuilder addActivityObservation(
      ActivityObservationTypeBuilder activityObservation) {
    if (activityObservation != null) {
      reportContent
          .getObservation()
          .add(ObservationTypeBuilder.createActivityObservation(activityObservation));
    }
    return this;
  }
   ...
   * @return this builder
   */
  public ObservationReportContentTypeBuilder addLocationObservation(
      LocationObservationTypeBuilder locationObservation) {
    if (locationObservation != null) {
      reportContent
          .getObservation()
          .add(ObservationTypeBuilder.createLocationObservation(locationObservation));
    }
    return this;
  }
   ...
   * @return this builder
   */
  public ObservationReportContentTypeBuilder addNameObservation(
      NameObservationTypeBuilder nameObservation) {
    if (nameObservation != null) {
      reportContent
          .getObservation()
          .add(ObservationTypeBuilder.createNameObservation(nameObservation));
    }
    return this;
  }
   ...
   * @return this builder
   */
  public ObservationReportContentTypeBuilder addHealthObservation(
      HealthObservationTypeBuilder healthObservation) {
    if (healthObservation != null) {
      reportContent
          .getObservation()
          .add(ObservationTypeBuilder.createHealthObservation(healthObservation));
    }
    return this;
  }
   ...
   * @return this builder
   */
  public ObservationReportContentTypeBuilder addResourceObservation(
      ResourceObservationTypeBuilder resourceObservation) {
    if (resourceObservation != null) {
      reportContent
          .getObservation()
          .add(ObservationTypeBuilder.createResourceObservation(resourceObservation));
    }
    return this;
  }
   ...
   * @return this builder
   */
  public ObservationReportContentTypeBuilder addSubjectObjectObservation(
      SubjectTypeObservationTypeBuilder subjectTypeObservation) {
    if (subjectTypeObservation != null) {
      reportContent
          .getObservation()
          .add(ObservationTypeBuilder.createSubjectObjectObservation(subjectTypeObservation));
    }
    return this;
  }
